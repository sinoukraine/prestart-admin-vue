...
<div class="p-grid p-fluid prestarts">
	<Dialog v-model:visible="isAddAssetModalOpened" class="m-dialog">
		<template #header>
			<h3>Add new asset</h3>
		</template>
				...
				<div class="card p-fluid">
					<div class="p-fluid p-formgrid p-grid">
						<div class="p-field p-col-6">
							<label for="name2">Asset Name</label>
							<InputText id="name2" type="text" />
						</div>
						<div class="p-field p-col-6">
							<label for="email2">Registration</label>
							<InputText id="email2" type="text" />
						</div>
						<div class="p-field p-col-6">
							<label for="name2">Make</label>
							<InputText id="name2" type="text" />
						</div>
						<div class="p-field p-col-6">
						...
						<div class="p-field p-col-6">
							<label for="name2">Group</label>
							<Dropdown v-model="selectedChecklist" :options="checklists" optionLabel="name" optionValue="code" :placeholder="'Select group'" class="" />
						</div>
						<div class="p-field p-col-6">
							<label for="email2">Checklist</label>
						...
						<div class="p-field p-col-6">
							<label for="name2">IMEI</label>
							<InputText id="email2" type="text" />
						</div>
						<div class="p-field p-col-6">
							<label for="email2">Device</label>
							<Dropdown v-model="selectedChecklist" :options="checklists" optionLabel="name" optionValue="code" :placeholder="'Select device'" class="" />
						</div>
					</div>
				</div>
			</div>
		...
		<template #footer class="align-left">
			<Button label="Create new asset" class="dark-btn mt-30 wl-100 p-button-md uppercase" autofocus />
		</template>
	</Dialog>

	<Dialog v-model:visible="isEditAssetModalOpened" class="m-dialog">
		<template #header>
			<h3>Edit details</h3>
		</template>
	...
	<form class="p-grid p-fluid w-form mb-15 mt-10" @submit.prevent="loadLazyData">        
      <div class="p-col-12 p-sm-6 p-md-3 p-lg-3">
        <label>Groups</label>
        <Dropdown v-model="selectedChecklist" :options="checklists" optionLabel="name" optionValue="code" :placeholder="'All groups'" class="" />
      </div>
      <div class="p-col" >
      ...
      <div class="p-col-12 p-sm-6 p-md-3 p-lg-3 p-col-fixed" style="width:200px">        
        <Button class="dark-btn mt-30 wl-100"  @click="isAddAssetModalOpened=true" label="NEW ASSET"/>
      </div>
    </form>
    ...
    <div class="card margin-bottom overflow-visible no-padding w-form my-20">    
      <div class="card-content min-height-140">
			<DataTable 
				...
				<Column field="MAKE" header="Make" :sortable="true" :style="{'width':'200px'}">
					
				</Column>
				
				<Column field="MODEL" header="Model" :sortable="true" :style="{'width':'300px'}">
					
				</Column>
				<Column field="COLOR" header="Color" :sortable="true" :style="{'width':'300px'}">
					
				</Column>
				<Column field="YEAR" header="Year" :sortable="true" :style="{'width':'300px'}">
					
				</Column>
				<Column field="GROUPS" header="Groups" :sortable="true" :style="{'width':'300px'}">
				...
				<Column field="INFO" :style="{'width':'160px'}">
					...
					<template #body>
						<router-link to="#"  @click="isEditAssetModalOpened=true">Edit details</router-link>
					</template>
				</Column>
			</DataTable>
		</div>
