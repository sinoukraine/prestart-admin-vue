...
<div class="p-grid p-fluid prestarts sms-page">
	...
	<form class="p-grid p-fluid w-form mb-15 mt-10" @submit.prevent="loadLazyData">        
      ...
      <div class="p-col-12 p-sm-6 p-md-3 p-lg-3 p-col-fixed" style="width:200px">        
        <Button class="dark-btn mt-30 wl-100"  @click="backToChat" label="BACK"/>
      </div>   
      <div class="p-col">
    ...
    <div class="card margin-bottom overflow-visible no-padding w-form my-20 dialog-chat-card" style="">    
      <div class="card-content min-height-140" style="height: 100%">
			<Toolbar style="height: 100%">
                <template v-slot:left>
                    <div id="messages" class="messages w-100"  style="">
                        <div
                        ...
                        <!--<div class="unreaded" />-->
                        <div class="dialog-chat-input-block" style="">
                        <form class="p-grid p-fluid w-form mb-15 mt-10" style="width:calc(100% + 8px)">        
                            ...
                            <div class="p-col-12 p-sm-3 p-md-2 p-lg-1">        
                                <Button class="p-button-primary green-btn" label="SEND"/>
                            </div>
                        </form>
                        </div>
                </template>
